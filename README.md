...
| Property                | Default value                                                                      | Overridable | Object |
|-------------------------|------------------------------------------------------------------------------------|:-----------:|:------:|
| og:url                  | the url is generated by the component router                                       |             |   yes  |
| og:title                | will use the 68 first characters of the article title                              |     yes     |   yes  |
| og:description          | will use the 200 first characters of the article text                              |     yes     |   yes  |
| og:image                | will use the article images (the biggest one)                                      |     yes     |   yes  |
...
| og:type                 | article or video (website will be soon available for multi-items views)            |     yes     |        |
...
| og:updated_time         | date of last modification in ISO8601                                               |             |   yes  |
| og:see_also             | only available manually (article selector to link related items)                   |     yes     |        |
| article:author          | socialmeta configuration (fig.2-4)                                                 |     yes     |   yes  |
| article:expiration_time | automatical from object table                                                      |             |   yes  |
| article:modified_time   | automatical from object table                                                      |             |   yes  |
| article:published_time  | automatical from object table                                                      |             |   yes  |
| article:publisher       | socialmeta configuration (fig.2-5)                                                 |     yes     |        |
| article:section         | automatical from object table                                                      |             |   yes  |
| article:tag             | automatical from object table                                                      |             |   yes  |
...
| twitter:site            | socialmeta configuration (fig.2-6)                                                 |     yes     |   yes  |
